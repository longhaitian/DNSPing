...
* TCPPing(in /Source/Linux/Tools) 53 port of server if you want to using TCP protocol.

TCPTraceroute
* Tcptraceroute 53 port of server if you want to using TCP protocol to traceroute.
